...
struct ExerciseData: ExerciseInfo, ExerciseInstruction, ExerciseParam, Codable {
    ...
    init(toJson exerciseName: String, _ description: String, _ thighAngle_min: Int16, _ thighAngle_max: Int16, _ legAngle_min: Int16, _ legAngle_max: Int16, _ instructions: Instruction?) {
