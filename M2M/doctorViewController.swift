...
class doctorViewController: UIViewController {
    ...
    static func storyboardInstance() -> doctorViewController? {
        let storyboard: UIStoryboard = UIStoryboard(name: String(describing: doctorViewController.self), bundle: nil)
        return storyboard.instantiateInitialViewController() as? doctorViewController
    }
